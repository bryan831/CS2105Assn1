...
class TCPClient {
	public static void main(String args[]) {
		...
		try 
		{
			...
			System.out.println("Connected to " + hostname + " at port " + port + " successfully.");
		} 
		catch (IOException e)
		{
		...
		try 
		{
			...
			System.out.println("Your InputStream BufferedReader and DataOutputStreams are set up.");
			...
			while (true)
			{
				...
				if (line.equals("")) 
				{
					System.out.println("Client is going to break due to line.equals(\"\")");
					//dos.writeBytes("\r\n");
					break;
				}
				System.out.println("Client is going to writeBytes to output stream.");
				dos.writeBytes(line + "\r\n");
			}
			//dos.flush();
			System.out.println("Client is done with writing to output stream");
